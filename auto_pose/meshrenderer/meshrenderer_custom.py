...
class Renderer(object):
    ...
    def __init__(self, models_cad_files, samples=1, vertex_tmp_store_folder='.', clamp=False, vertex_scale=1.0):
        ...
        for attribute in attributes:
            ...
            uv = None
            if len(attribute) == 5:
                vertex, normal, color, faces, uv = attribute
            elif len(attribute) == 4:
                if attribute[2].dtype == np.float32:
                    vertex, normal, uv, faces = attribute
                else:
